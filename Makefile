...
INCPATH = includes/
SRCPATH = srcs/
SRCS = cd.c custom_split.c echo.c env.c exit.c export.c handle_print.c libft1.c libft2.c libft3.c libft4.c libft5.c main.c parsing1.c parsing2.c pipe1.c pipe2.c pipe3.c pwd.c random.c readline.c signal.c split.c split_cmd.c unset.c
