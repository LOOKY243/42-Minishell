...
INCPATH = includes/
SRCPATH = srcs/
SRCS = cd.c echo.c env.c exit.c export.c handle_print.c libft1.c libft2.c libft3.c main.c pipe1.c pwd.c random.c readline.c signal.c split.c split_cmd.c unset.c
